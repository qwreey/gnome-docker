...
RUN --mount=type=cache,target=/var/cache/pacman pacman -Suy --noconfirm gtk3-demos avahi ibus playerctl dconf-editor d-spy firefox vulkan-radeon mesa xorg-xrandr tigervnc freerdp2 gnome xorg-server-xvfb
